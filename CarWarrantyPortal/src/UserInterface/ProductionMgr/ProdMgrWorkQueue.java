 ...
 */
public class ProdMgrWorkQueue extends javax.swing.JPanel {
                  // ATTRIBUTES
     ...
     */
    public ProdMgrWorkQueue(JPanel csp, User usr, ProductionOrganization org, Ecosystem system) {
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        if (selectedTask.getAssignee() != null) {
            ...
            return;
        } else if (((ProductionManager) user.getRole()).getCurrentTask() != null) {
        ...
        ((ProductionManager) user.getRole()).setCurrentTask(selectedTask);
